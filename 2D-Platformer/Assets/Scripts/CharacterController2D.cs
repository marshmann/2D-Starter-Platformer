...
//Obtained at https://github.com/Brackeys/2D-Character-Controller/blob/master/CharacterController2D.cs
...
public class CharacterController2D : MonoBehaviour {
    ...
    private void Awake() {
        ...
        if (player == null) 
            player = GameObject.FindGameObjectWithTag("Player").transform.GetChild(0).GetComponent<Animator>();
